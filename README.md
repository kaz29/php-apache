...
```
$ cd 8.2.1
$ docker buildx build --platform linux/amd64,linux/arm64/v8 -t kaz29/php-apache:8.2.1 .
$ docker buildx build --platform linux/amd64,linux/arm64/v8 -t kaz29/php-apache:8.2.1 --push .
```
### run 

```
$ docker run -it --rm -d --name php-apache-8.2.1 kaz29/php-apache:8.2.1
```
...
```
$ cd 8.1.10
$ docker buildx build --platform linux/amd64,linux/arm64/v8 -t kaz29/php-apache:8.1.10 .
$ docker buildx build --platform linux/amd64,linux/arm64/v8 -t kaz29/php-apache:8.1.10 --push .
```
### run 

```
$ docker run -it --rm -d --name php-apache-8.1.10 kaz29/php-apache:8.1.10
```
...
```
$ cd 8.1.7
$ docker buildx build --platform linux/amd64,linux/arm64/v8 -t kaz29/php-apache:8.1.7 .
$ docker buildx build --platform linux/amd64,linux/arm64/v8 -t kaz29/php-apache:8.1.7 --push .
```
### run 

```
$ docker run -it --rm -d --name php-apache-8.1.7 kaz29/php-apache:8.1.7
```
...
```
$ cd 8.1.1
$ docker buildx build --platform linux/amd64,linux/arm64/v8 -t kaz29/php-apache:8.1.1 .
$ docker buildx build --platform linux/amd64,linux/arm64/v8 -t kaz29/php-apache:8.1.1 --push .
```
### run 

```
$ docker run -it --rm -d --name php-apache-8.1.1 kaz29/php-apache:8.1.1
```
...
```
$ cd 8.1.0
$ docker buildx build --platform linux/amd64,linux/arm64/v8 -t kaz29/php-apache:8.1.0 .
$ docker buildx build --platform linux/amd64,linux/arm64/v8 -t kaz29/php-apache:8.1.0 --push .
```
### run 
...
```
$ cd 8.0.20
$ docker buildx build --platform linux/amd64,linux/arm64/v8 -t kaz29/php-apache:8.0.20 .
$ docker buildx build --platform linux/amd64,linux/arm64/v8 -t kaz29/php-apache:8.0.20 --push .
```
### run 

```
$ docker run -it --rm -d --name php-apache-8.0.20 kaz29/php-apache:8.0.20
```
## 8.0.14
...
```
$ cd 8.0.14
$ docker buildx build --platform linux/amd64,linux/arm64/v8 -t kaz29/php-apache:8.0.14 .
$ docker buildx build --platform linux/amd64,linux/arm64/v8 -t kaz29/php-apache:8.0.14 --push .
```
### run 

```
$ docker run -it --rm -d --name php-apache-8.0.14 kaz29/php-apache:8.0.14
```
...
```
$ docker run -it --rm -d --name php-apache-8.0.13 kaz29/php-apache:8.0.13
```
